...
OUTFILE = 'C:/tmp/lsat_tundra_shrub_forbes_slices_buf0m_20190507.csv'
...
sites = ee.FeatureCollection('users/loganberner/tundra_shrub_forbes_slice_coords_20190501')
